		...
		<div class="cards">
			<p>상세 글 보기</p>
				...
				<table id="newtab" border="1">
					...
					<tr><td colspan="2"><a href="${contextPath}/lordMeeting/modForm.do?boPostKey=${boardVO.boPostKey }" class="g">글 수정하기</a></td></tr>
					<tr><td colspan="2"><a href="${contextPath}/lordMeeting/del.do?boPostKey=${boardVO.boPostKey }" class="g">글 삭제하기 </a></td></tr>
