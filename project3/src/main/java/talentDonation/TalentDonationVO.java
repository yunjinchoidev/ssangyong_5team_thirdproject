...
public class TalentDonationVO {
	...
	public TalentDonationVO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TalentDonationVO(int talenKey, String talentYouWant, String talenChildPer, String talenDate, String talenLoc,
			int mKey) {
		super();
