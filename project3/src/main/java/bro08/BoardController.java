	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (action==null){	
				...
				nextPage = "/views/board07/listArticles.jsp";
				...
				nextPage = "/views/board07/articleForm.jsp";
				...
				nextPage = "/views//board07/viewArticle.jsp";
				...
				nextPage = "/views//board07/replyForm.jsp";
