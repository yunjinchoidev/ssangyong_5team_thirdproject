...
public class LiteraryContestVO {
	...
	private String literSubmissionDateS;
	private int mKey;
	private int fileKey;
	...
	public LiteraryContestVO(int literKey, String literTitle, String literContents, String literSort,
			String literCareer, int literProductionDate, Date literSubmissionDate, String literSubmissionDateS,
		...
		this.literSubmissionDateS = literSubmissionDateS;
		this.mKey = mKey;
	...
	public LiteraryContestVO(int literKey, String literTitle, String literContents, String literSort,
			String literCareer, int literProductionDate, String literSubmissionDateS, int mKey, int fileKey) {
		super();
		this.literKey = literKey;
		this.literTitle = literTitle;
		this.literContents = literContents;
	...
	public String getLiterSubmissionDateS() {
		return literSubmissionDateS;
	}

	public void setLiterSubmissionDateS(String literSubmissionDateS) {
		this.literSubmissionDateS = literSubmissionDateS;
	}
