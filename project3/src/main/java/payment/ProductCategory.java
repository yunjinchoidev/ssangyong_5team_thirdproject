...
public class ProductCategory {
	private int purchKey;
	private String contents;
	private int purchScore;
	private int purchlikecnt;
	private int purchdontlikecnt;
	private int purchview;
	...
	public ProductCategory(int purchKey, String contents, int purchScore, int purchlikecnt, int purchdontlikecnt,
