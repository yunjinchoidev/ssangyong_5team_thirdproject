...
public class MemberVO2 {
	...
	public MemberVO2(int mKey, String mId, String mPass, String mName, String mEmail, int mReg, char mGender,
			int mManiaQuot, Date mJoinDate, int mAuthNum, int mCash, int mPoint, int mLevel, char mEmailWhether,
			String mAddress, char mState, String mBlockList, double mSellerRate, int mGiftLevel, char mUnderFifteen,
			char mGiftDoneExist, int mGiftDoneCnt, String mMyGift, String mIp) {
		super();
		this.mKey = mKey;
		this.mId = mId;
		this.mPass = mPass;
