	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (action==null){	
				...
				nextPage = "/views/2_upmenubar/6_freeboard/listArticles.jsp";
				...
				nextPage = "/views/2_upmenubar/6_freeboard/articleForm.jsp";
				...
				pw.print("<script>" + "  alert('������ �߰��߽��ϴ�.');" + " location.href='" + request.getContextPath()
						+ "/freeboard/listArticles.do';" + "</script>");
				return;
				...
				nextPage = "/views/2_upmenubar/6_freeboard/viewArticle.jsp";
				...
				pw.print("<script>" + "  alert('���� �����߽��ϴ�.');" + " location.href='" + request.getContextPath()
						+ "/freeboard/viewArticle.do?articleNO=" + articleNO + "';" + "</script>");
				return;
				...
				nextPage = "/views/2_upmenubar/6_freeboard/replyForm.jsp";
